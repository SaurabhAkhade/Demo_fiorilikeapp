sap.ui.define(
  ...
  function (BaseController, JSONModel, MessageBox, MessageToast, Fragment) {
    "use strict";
    return BaseController.extend("kpit.fin.ap.controller.Add", {
      productPayload: {
        PRODUCT_ID: "",
        TYPE_CODE: "PR",
        CATEGORY: "Notebooks",
        NAME: "",
        DESCRIPTION: "",
        SUPPLIER_ID: "0100000041",
        SUPPLIER_NAME: "South American IT Company",
        TAX_TARIF_CODE: "1 ",
        MEASURE_UNIT: "EA",
        PRICE: "0.00",
        CURRENCY_CODE: "EUR",
        ...
        oDataModel.read("/ProductSet('" + this.prodId + "')", {
          success: function (data) {
            ...
            that
              ...
              .byId("prodImage")
              .setSrc(
                "/sap/opu/odata/sap/ZSA_ODATA_SRV/ProductImgSet('" +
                  that.prodId +
                  "')/$value"
              );
          },
...
//             // Step 2: validate the data
//               if (!payload.PRODUCT_ID || !payload.NAME){
//                 MessageBox.error("The mandatory data was missed");
//                 return;
//               }
//             // Step 3: enchanced the data if needed
//              payload.PRODUCT_PIC_URL = payload.PRODUCT_PIC_URL +  payload.PRODUCT_ID;
//             // step 4: get odata model object  default model @ app level
//               var oDataModel = this.getOwnerComponent().getModel();
//               // step 5: trigger the post call
//               oDataModel.create("/ProductSet",payload,{
//                 // step 6:  sucess call back-- save was succesfull
//                    success: function(data){
//                     MessageToast.show("Boom your product was saved ");
//                    },
//                 // step 7:  error  call back-- unable to save data
//                    error:function(oError){
